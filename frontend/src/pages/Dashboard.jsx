...
export function Dashboard() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((resposta) => {
        /*
         * Confirma que o backend retornou um objeto.
         * Se a resposta for vazia ou inválida, utiliza um objeto vazio.
         */
        const resultado =
          resposta.data &&
        ...
        /*
         * Mantém os valores padrões quando algum campo
         * não for retornado pelo backend.
         */
        setDados((dadosAtuais) => ({
          ...
          /*
           * consumoEmbalagens é um objeto interno.
           * Por isso, também precisa ser combinado separadamente.
           */
          consumoEmbalagens: {
            ...dadosAtuais.consumoEmbalagens,
            ...(resultado.consumoEmbalagens ?? {}),
          },

          /*
           * Garante que os campos utilizados com map()
           * sempre sejam listas.
           */
          evolucaoFaturamento: Array.isArray(resultado.evolucaoFaturamento)
            ? resultado.evolucaoFaturamento
            : [],

          melhoresClientes: Array.isArray(resultado.melhoresClientes)
            ? resultado.melhoresClientes
            : [],

          produtosMaisVendidos: Array.isArray(resultado.produtosMaisVendidos)
            ? resultado.produtosMaisVendidos
            : [],

          historicoEmbalagens: Array.isArray(resultado.historicoEmbalagens)
            ? resultado.historicoEmbalagens
            : [],
        }));
      })
      .catch((error) => {
        ...
        <div className="flex flex-col gap-3 lg:col-span-2 sm:gap-4">
          ...
          >
            <div
              ...
              style={{ height: "320px", minHeight: "320px" }}
            >
              {dados.historicoEmbalagens &&
              dados.historicoEmbalagens.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart
                    data={dados.historicoEmbalagens}
