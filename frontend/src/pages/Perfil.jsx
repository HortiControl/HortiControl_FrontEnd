...
export default function Perfil() {
    ...
    const handleSalvarPerfil = async () => {
        try {
            await axios.put(`http://localhost:8080/usuarios/perfil/${userId}`, perfil, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleAtualizarSenha = async () => {
        ...
        try {
            await axios.put(`http://localhost:8080/usuarios/senha/${userId}`, {
            ...
            alert("Erro ao atualizar senha. Verifique se sua senha atual está correta.");
            console.error(error);
        }
    };
    ...
    return (
        <div className="p-4 max-w-6xl">
            <Link to="/" className="flex items-center text-xs text-gray-500 hover:text-gray-700 mb-4 transition-colors">
            ...
            <div className="space-y-6">
                ...
                <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
                    ...
                    <div className="mt-8">
                        <button onClick={handleSalvarPerfil} className="bg-[#00a859] hover:bg-[#008f4c] text-white px-6 py-2.5 rounded-lg flex items-center gap-2 text-sm font-bold transition-colors cursor-pointer">
                ...
                <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
                    ...
                    <div className="mt-8">
                        <button onClick={handleAtualizarSenha} className="bg-[#00a859] hover:bg-[#008f4c] text-white px-6 py-2.5 rounded-lg flex items-center gap-2 text-sm font-bold transition-colors cursor-pointer">
